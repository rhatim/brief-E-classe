        ...
        <div class="row">
            ...
            <div id="sideb" style="background-color: #FAFFC1; " class=" col-md-3  col-sm-6 text-center  ">
                ...
                <ul class="nav nav-pills mt-5 d-flex flex-column">
                    <li class=""><a class="ps-0 text-dark btn btn-outline-info border-0 my-2" href="p2.php"><i class="bi bi-house-door mx-3"></i><span class=" ">Home</span></a></li>
                    ...
                    <li><a class="ps-0 text-dark btn btn-outline-info border-0 my-2" href="students.php"><i class="bi bi-mortarboard mx-3"></i><span class=" ">Students</span></a></li>
                    <li><a class="ps-0 text-dark btn btn-outline-info border-0 " href="pay.php"><i class="bi bi-currency-dollar mx-3"></i><span class=" ">Payment</span></a></li>
